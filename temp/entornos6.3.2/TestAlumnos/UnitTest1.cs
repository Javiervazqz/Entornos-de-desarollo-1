...
namespace TestAlumno
{
    ...
    {
        [Test]
        public void TestAgregarYObtener_Alumno_ConDatosValidos([Values("Roberto", "Ana", "Juan")]
        ...
        {
            var alumnos = new Alumnos();
            alumnos.Agregar(new Alumno("Roberto", 5));
        ...
        {
            var alumnos = new Alumnos();
            alumnos.Agregar(new Alumno("Roberto", 8));
            alumnos.Agregar(new Alumno("Pepe", 6));
